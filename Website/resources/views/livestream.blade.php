...
<div ng-app="raspiSurveillanceApp">
    <div class="row">
        <div class="col-lg-6">
            <div ng-controller="CameraModeCtrl">
                <h3>Local Camera</h3>
                ...
                <table class="table table-condensed borderless">
                    ...
                    <tr>
                        <td>Stream:</td>
                        <td>
                            <span ng-show="mode !== 1">The stream is currently turned off and can't be watched.</span>
        ...
        <div class="col-lg-6" ng-controller="CameraManagementCtrl">
            ...
            <div class="table-responsive">
                <table class="table table-striped vert-aligh" ng-cloack>
                    <tr>
                        <th style="width: 100%">
                        ...
                        <th style="width: 0%">
                            <a href="#" ng-click="orderBy('ip_address')">IP-Address
                        ...
                        <th style="width: 0%">
                            <a href="#" ng-click="orderBy('port')">Port
                        ...
                        <th style="width: 0%">
                            <a href="#" ng-click="orderBy('protocol')">Protocol
                    ...
                    <tr ng-repeat="camera in cameras | filter:query | orderBy:orderField:orderReverse">
                        <td>
                            <!-- Name -->
                            <span editable-text="camera.name" e-name="name" e-form="cameraForm" onbeforesave="validateName($data, camera.id)">@{{ camera.name }}
                            </span>
                        </td>
                        <td>
                            <!-- IP address -->
                            <span editable-text="camera.ip_address" e-name="ip_address" e-form="cameraForm" e-required onbeforesave="validateIpAddress($data, camera.id)">@{{ camera.ip_address }}
                            </span>
                        </td>
                        <td>
                            <!-- Port -->
                            <span editable-text="camera.port" e-name="port" e-form="cameraForm" e-required onbeforesave="validatePort($data, camera.id)">@{{ camera.port }}
                            </span>
                        </td>
                        <td>
                            <!-- Protocol -->
                            <span editable-text="camera.protocol | uppercase" e-name="protocol" e-form="cameraForm" e-required onbeforesave="validateProtocol($data, camera.id)">@{{ camera.protocol | uppercase }}
                            </span>
                        </td>
