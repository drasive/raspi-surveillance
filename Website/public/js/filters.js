...
raspiSurveillanceApp.filter('naturalSort', function () {
  ...
  return function (data, property, reversed) {
    ...
    // Sort data by the specified property
    naturalSort.insensitive = true;

    dataArray.sort(function (object1, object2) {
      return naturalSort(object1[property], object2[property]);
    });
